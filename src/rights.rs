...
pub const REPL_GET_CHANGES: Right = Right::new(
    "DS-Replication-Get-Changes",
    "1131f6aa-9c07-11d1-f79f-00c04fc2dcd2",
);
pub const REPL_GET_CHANGES_ALL: Right = Right::new(
    "DS-Replication-Get-Changes-All",
    "1131f6ad-9c07-11d1-f79f-00c04fc2dcd2",
);

// User-Force-Change-Password ⇒ takeover without knowing current password.
pub const FORCE_CHANGE_PASSWORD: Right = Right::new(
    "User-Force-Change-Password",
    "00299570-246d-11d0-a768-00aa006e0529",
);

// Write msDS-KeyCredentialLink ⇒ Shadow Credentials.
pub const KEY_CREDENTIAL_LINK: Right = Right::new(
...
pub const RBCD_ATTR: Right = Right::new(
...
pub const ENROLLMENT: Right = Right::new(
    "Certificate-Enrollment",
    "0e10c968-78fb-11d2-90d4-00c04f79dc55",
);
pub const AUTO_ENROLLMENT: Right = Right::new(
